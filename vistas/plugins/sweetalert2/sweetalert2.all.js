...
var setParameters = function setParameters(params) {
  ...
  if (params.type) {
    ...
    var icon = popup.querySelector('.' + swalClassesn + '.' + iconTypes[params.type]);
    show(icon);
...
var getIcons = function getIcons() {
  var popup = getPopup();
  return popup.querySelectorAll('.' + swalClassesn);
};
